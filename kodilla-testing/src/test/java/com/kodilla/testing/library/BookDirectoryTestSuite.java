...
//        when(libraryDatabaseMock.listBookWithCondition("first")).thenReturn(resultListOfBooks);
//
//        //when
...
//        when(libraryDatabaseMock.listBooksWithCondition("15Books"())).thenReturn(resultListOf15Books);
//        when(libraryDatabaseMock.listBooksWithCondition("ZeroBooks"()).thenReturn(resultListOf0Books);
//        when(libraryDatabaseMock.listBooksWithCondition("FourthBooks"()).thenReturn(resultListOf40Books);
//
//        //When
